...
from SHASHA_DRUGZ.utils import extract_user, int_to_alpha
...
from SHASHA_DRUGZ.utils.decorators import AdminActual, language
...
__mod_name__ = "H_B_45"
__help__ = """
🔻 /auth ➠ ᴀᴜᴛʜᴏʀɪᴢᴇꜱ ᴀ ᴜꜱᴇʀ ᴛᴏ ᴜꜱᴇ ᴀᴅᴍɪɴ-ʟɪᴋᴇ ꜰᴇᴀᴛᴜʀᴇꜱ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ (ᴀᴅᴍɪɴꜱ ᴏɴʟʏ).
🔻 /unauth ➠ ʀᴇᴍᴏᴠᴇꜱ ᴀ ᴜꜱᴇʀ ꜰʀᴏᴍ ᴛʜᴇ ᴀᴜᴛʜᴏʀɪᴢᴇᴅ ᴜꜱᴇʀ ʟɪꜱᴛ (ᴀᴅᴍɪɴꜱ ᴏɴʟʏ).
🔻 /authlist ➠ ꜱʜᴏᴡꜱ ᴀ ʟɪꜱᴛ ᴏꜰ ᴀʟʟ ᴀᴜᴛʜᴏʀɪᴢᴇᴅ ᴜꜱᴇʀꜱ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ.
🔻 /authusers ➠ ᴅɪꜱᴘʟᴀʏꜱ ᴛʜᴇ ᴀᴜᴛʜᴏʀɪᴢᴇᴅ ᴜꜱᴇʀꜱ ᴀʟᴏɴɢ ᴡɪᴛʜ ᴀᴅᴍɪɴ ᴅᴇᴛᴀɪʟꜱ.
"""

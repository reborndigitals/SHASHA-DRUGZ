...
#  /quickpoll
# ══════════════════════════════════════════════════════════════
@app.on_message(filters.command("quickpoll"))
...
# ══════════════════════════════════════════════════════════════
@app.on_callback_query(filters.regex(r"^poll_"))
...
#  /pollhelp
# ══════════════════════════════════════════════════════════════
@app.on_message(filters.command("pollhelp"))
...
⚙️ ᴀᴅᴅ `await on_poll_startup()` ᴛᴏ ʏᴏᴜʀ sᴛᴀʀᴛᴜᴘ ʜᴏᴏᴋ.
"""

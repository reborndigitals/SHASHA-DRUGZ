...
# -------------------------
@app.on_callback_query(filters.regex(r"^jr:cancel_log_prompt$"))
...
# Admin callbacks
# -------------------------
@app.on_callback_query(filters.regex(r"^jr:(approve|decline_prompt|decline_reason|view|mute|ban):-?\d+:\d+$"))

...
# ─────────────────────────────────────────
@app.on_chat_join_request(group=-1)
...
# ─────────────────────────────────────────
@app.on_message(filters.command(["joinreq", "joinrequest"]) & filters.group, group=-1)
...
# Approve All Command
# ─────────────────────────────────────────
@app.on_message(filters.command("approveall") & filters.group, group=-1)
...
# ─────────────────────────────────────────
@app.on_callback_query(filters.regex(r"^jr:cancel_log_prompt$"), group=-1)
...
@app.on_message(filters.private & _log_setup_filter, group=-1)
...
@app.on_message(filters.private & _pending_reason_filter, group=-1)

...
async def style_buttons(c, m, cb=False):
    ...
    buttons = [
        ...
        [
            ...
            # Fixed callback: "smallcap" (matches method name)
            InlineKeyboardButton("Sᴍᴀʟʟ Cᴀᴘs", callback_data="style+smallcap"),
        ],
        [
...
__mod_name__ = "H_B_17"
__help__ = """
🔻 /fonts <text> ➠ ᴄᴏɴᴠᴇʀᴛꜱ ɴᴏʀᴍᴀʟ ᴛᴇxᴛ ɪɴᴛᴏ ᴍᴜʟᴛɪᴘʟᴇ ʙᴇᴀᴜᴛɪꜰᴜʟ ꜱᴛʏʟɪꜱʜ ꜰᴏɴᴛꜱ.
"""

...
from SHASHA_DRUGZ.utils.database import get_assistant, get_authuser_names, get_cmode
from SHASHA_DRUGZ.utils.decorators import ActualAdminCB, AdminActual, language
from SHASHA_DRUGZ.utils.formatters import alpha_to_int, get_readable_time
...
async def restartbot(client, message: Message, _):
    ...
    if chat_id:
        ...
        try:
            db[chat_id] = []
            await SHASHA.stop_stream_force(chat_id)
        except:
            pass
    return await mystic.edit_text(_["reload_5"].format(app.mention))
@Client.on_message( filters.command("starts") & filters.private & filters.user(int(HEHE)))
...
__mod_name__ = "H_B_57"
__help__ = """
🔻 /admincache ➠ ʀᴇʟᴏᴀᴅ ᴀᴅᴍɪɴ ᴄᴀᴄʜᴇ ғᴏʀ ᴛʜᴇ ɢʀᴏᴜᴘ
🔻 /reload ➠ sʏɴᴏɴʏᴍ ғᴏʀ /admincache, ʀᴇʟᴏᴀᴅ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴs
🔻 /refresh ➠ sʏɴᴏɴʏᴍ ғᴏʀ /admincache, ʀᴇʟᴏᴀᴅ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴs
🔻 /reboot ➠ ʀᴇsᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ ᴀɴᴅ sᴛᴏᴘ ᴀʟʟ ᴄᴜʀʀᴇɴᴛ ᴍᴜsɪᴄ ᴘʟᴀʏɪɴɢ
🔻 /starts ➠ sʜᴏᴡ ʙᴏᴛ ᴛᴏᴋᴇɴ, ᴍᴏɴɢᴏ ᴜʀɪ, ᴀɴᴅ sᴛʀɪɴɢ sᴇssɪᴏɴ ɪɴ ᴘʀɪᴠᴀᴛᴇ (ᴏɴʟʏ ʙᴏᴛ ᴏᴡɴᴇʀ)
"""

...
from SHASHA_DRUGZ.utils import SHASHABin, get_channeplayCB, seconds_to_min
from SHASHA_DRUGZ.utils.database import get_cmode, is_active_chat, is_music_playing
from SHASHA_DRUGZ.utils.decorators.language import language, languageCB
from SHASHA_DRUGZ.utils.inline import queue_back_markup, queue_markup
...
__mod_name__ = "H_B_56"
__help__ = """
🔻 /queue ➠ sʜᴏᴡs ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴍᴜsɪᴄ ᴘʟᴀʏɪɴɢ ᴏʀ ǫᴜᴇᴜᴇᴅ ᴛʀᴀᴄᴋs ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ
🔻 /cqueue ➠ sʜᴏᴡs ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴍᴜsɪᴄ ᴘʟᴀʏɪɴɢ ᴏʀ ǫᴜᴇᴜᴇᴅ ᴛʀᴀᴄᴋs ɪɴ ᴄʜᴀɴɴᴇʟ ᴍᴏᴅᴇ
🔻 /player ➠ sʜᴏᴡs ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴍᴜsɪᴄ ᴘʟᴀʏɪɴɢ ᴏʀ ǫᴜᴇᴜᴇᴅ ᴛʀᴀᴄᴋs ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ
🔻 /cplayer ➠ sʜᴏᴡs ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴍᴜsɪᴄ ᴘʟᴀʏɪɴɢ ᴏʀ ǫᴜᴇᴜᴇᴅ ᴛʀᴀᴄᴋs ɪɴ ᴄʜᴀɴɴᴇʟ ᴍᴏᴅᴇ
🔻 /playing ➠ sʜᴏᴡs ᴡʜɪᴄʜ ᴛʀᴀᴄᴋ ɪs ᴄᴜʀʀᴇɴᴛʟʏ ᴘʟᴀʏɪɴɢ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ
🔻 /cplaying ➠ sʜᴏᴡs ᴡʜɪᴄʜ ᴛʀᴀᴄᴋ ɪs ᴄᴜʀʀᴇɴᴛʟʏ ᴘʟᴀʏɪɴɢ ɪɴ ᴄʜᴀɴɴᴇʟ ᴍᴏᴅᴇ
"""
MOD_TYPE = "MUSIC"
MOD_NAME = "Queue"
MOD_PRICE = "10"

...
async def vclogger_command(client, message: Message):
...
@Client.on_message(filters.command("reload_vclog", prefixes=PREFIXES) & filters.user(1281282633)) # Placeholder for debug

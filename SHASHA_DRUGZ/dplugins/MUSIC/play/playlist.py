...
async def del_plist_msg(client, message: Message, _):
    ...
    if _playlist:
        ...
        return await message.reply_text(_["playlist_3"])
    keyboard, count = await get_keyboard(client, message.from_user.id)
    await get.edit_text(
...
@Client.on_callback_query(filters.regex("shasha_playlist") & ~BANNED_USERS)
@languageCB
...
__mod_name__ = "H_B_35"
__help__ = """
🔻 /playlist ➠ sʜᴏᴡs ᴀʟʟ sᴏɴɢs ɪɴ ʏᴏᴜʀ ʙᴏᴛ ᴘʟᴀʏʟɪsᴛ
🔻 /addplaylist <song name | youtube link | playlist link> ➠ ᴀᴅᴅs ᴀ sᴏɴɢ ᴏʀ ᴀɴ ᴇɴᴛɪʀᴇ ʏᴏᴜᴛᴜʙᴇ ᴘʟᴀʏʟɪsᴛ ᴛᴏ ʏᴏᴜʀ ʙᴏᴛ ᴘʟᴀʏʟɪsᴛ
🔻 /delplaylist ➠ ᴅᴇʟᴇᴛᴇs sᴇʟᴇᴄᴛᴇᴅ sᴏɴɢs ғʀᴏᴍ ʏᴏᴜʀ ᴘʟᴀʏʟɪsᴛ
🔻 /delallplaylist ➠ ᴅᴇʟᴇᴛᴇs ᴛʜᴇ ᴇɴᴛɪʀᴇ ᴘʟᴀʏʟɪsᴛ (ᴄᴏɴғɪʀᴍᴀᴛɪᴏɴ ʀᴇǫᴜɪʀᴇᴅ)
🔻 /playplaylist ➠ ᴘʟᴀʏs ᴀʟʟ sᴏɴɢs ғʀᴏᴍ ʏᴏᴜʀ ᴘʟᴀʏʟɪsᴛ ɪɴ ᴏʀᴅᴇʀ
🔻 /playplaylist v ➠ ᴘʟᴀʏs ʏᴏᴜʀ ᴘʟᴀʏʟɪsᴛ ɪɴ ᴠɪᴅᴇᴏ ᴍᴏᴅᴇ
"""
MOD_TYPE = "MUSIC"
MOD_NAME = "PlayList"
MOD_PRICE = "50"

...
@Client.on_callback_query(filters.regex(r"^nsfw_"))
...
# Admin commands
@Client.on_message(filters.command("setnsfw") & filters.group)
...
@Client.on_message(filters.command("setwarnimage") & filters.group)
...
@Client.on_message(filters.command("setmutetime") & filters.group)

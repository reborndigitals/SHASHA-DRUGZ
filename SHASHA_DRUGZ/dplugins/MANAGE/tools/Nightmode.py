...
from SHASHA_DRUGZ.mongo.nightmodedb import nightdb,nightmode_on,nightmode_off,get_nightchats 
...
async def _nightmode(client: Client, message):
...
__mod_name__ = "H_B_50"
__help__ = """
🔻 /nightmode ➠ ᴇɴᴀʙʟᴇ / ᴅɪsᴀʙʟᴇ ɴɪɢʜᴛᴍᴏᴅᴇ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ (ᴀᴅᴍɪɴ ᴏɴʟʏ)
⏰ ɢʀᴏᴜᴘ ᴄʟᴏsᴇs : 12:00 ᴀᴍ (ɪsᴛ)
🌅 ɢʀᴏᴜᴘ ᴏᴘᴇɴs : 06:00 ᴀᴍ (ɪsᴛ)
"""
MOD_TYPE = "MANAGEMENT"
MOD_NAME = "NightMode"
MOD_PRICE = "40"

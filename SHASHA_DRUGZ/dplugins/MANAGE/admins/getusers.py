...
@Client.on_message(filters.command("getusers") & admin_filter)
...
@Client.on_message(filters.command("getink"))
...
__mod_name__ = "H_B_28"
__help__ = """
🔻 /getusers ➠ ɢᴇᴛs ᴀʟʟ ᴜsᴇʀs ɪɴ ᴛʜᴇ ᴄʜᴀᴛ ᴀɴᴅ sᴇɴᴅs ᴀ ᴄsᴠ ғɪʟᴇ
🔻 /getlink ➠ ɢᴇɴᴇʀᴀᴛᴇs ᴀɴ ɪɴᴠɪᴛᴇ ʟɪɴᴋ ғᴏʀ ᴛʜᴇ ᴄʜᴀᴛ
"""

...
@Client.on_message(filters.command("spurge") & admin_filter)
...
@Client.on_message(filters.command("del") & admin_filter)
...
__mod_name__ = "H_B_3"
__help__ = """
🔻 /purge <reply to message> ➠ ᴅᴇʟᴇᴛᴇ ᴀʟʟ ᴍᴇssᴀɢᴇs ʙᴇᴛᴡᴇᴇɴ ʏᴏᴜʀ ʀᴇᴘʟʏ ᴀɴᴅ ᴛʜɪs ᴍᴇssᴀɢᴇ
🔻 /spurge <reply to message> ➠ sɪᴍɪʟᴀʀ ᴛᴏ /purge, ʀᴇᴍᴏᴠᴇs ᴍᴇssᴀɢᴇs ʙᴜᴛ ʏᴏᴜ ᴄᴀɴ ᴜsᴇ ɪɴ ʟᴀʀɢᴇ ʀᴀɴɢᴇs
🔻 /del <reply> ➠ ᴅᴇʟᴇᴛᴇ ᴀ sɪɴɢʟᴇ ᴍᴇssᴀɢᴇ ʀᴇᴘʟɪᴇᴅ ᴛᴏ
"""
MOD_TYPE = "MANAGEMENT"
MOD_NAME = "Purge"
MOD_PRICE = "30"

...
async def active_afk(client: Client, message: Message):
...
async def chat_watcher_func(client: Client, message):
    if message.sender_chat:
        return
...
__mod_name__ = "H_B_3"
__help__ = """
🔻 /afk /brb [reason] ➠ sᴇᴛ ʏᴏᴜʀ ᴀғᴋ sᴛᴀᴛᴜs ᴡɪᴛʜ ᴀɴ ᴏᴘᴛɪᴏɴᴀʟ ʀᴇᴀsᴏɴ
"""
